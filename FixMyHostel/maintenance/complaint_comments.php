...
if(!isset($_SESSION['user_id']) || !in_array(($_SESSION['role'] ?? ''), ['maintenance_associate', 'maintenance_supervisor'], true)){
...
$complaintQuery = $conn->query("
    ...
    WHERE c.complaint_id='$complaint_id_escaped' AND c.department='Maintenance'
    LIMIT 1
");
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="manage_complaints.php" class="btn btn-tool"><i class="fas fa-arrow-left"></i></a>
                        </div>
                    </div>
